package com.davidsgk.inverzion.camera;
...
public class OrthoCamera extends OrthographicCamera {
    ...
    public OrthoCamera() {
        this(new VirtualViewport(Inverzion.WIDTH, Inverzion.HEIGHT));
    }
    ...
    public void resize() {
        VirtualViewport virtualViewport = new VirtualViewport(Inverzion.WIDTH, Inverzion.HEIGHT);
